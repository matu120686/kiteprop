                    ...
                    <div class="text-black">
                        ...
                        <form action="{{ route('properties.update', $property->id) }}" method="POST">
                            ...
                            <div class="mb-4 text-lg">
                                <input class="rounded-3xl border-none px-6 py-2 text-center text-inherit  outline-none backdrop-blur-md"
                                    type="text"
                                    id="title"
                                    name="title"
                            ...
                            <div class="mb-4 text-lg">
                                <input class="rounded-3xl border-none px-6 py-2 text-center text-inherit  outline-none backdrop-blur-md" type="text" id="latitude" name="latitude" placeholder = "{{ $property->latitude }}" required/>
                            </div>
                            <div class="mb-4 text-lg">
                                <input class="rounded-3xl border-none px-6 py-2 text-center text-inherit  outline-none backdrop-blur-md" type="text" id="longitude" name="longitude" placeholder = "{{ $property->longitude }}tud" required/>
                            </div>
                            ...
                            <div class="mt-8 flex justify-center text-lg text-black">
                                <button type="submit" id="btn" disabled class="rounded-3xl px-10 py-2 text-white shadow-xl backdrop-blur-md transition-colors duration-300 hover:bg-blue-600">Editar</button>
                            </div>
                        </form>
                    </div>
                <!-- </div> -->
